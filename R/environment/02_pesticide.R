...
pyrethroid_all <- readRDS("clean_data/pesticide/pyrethroid_county.rds")
  ...
  saveRDS(gen_ld50, file = paste0("clean_data/pesticide/gen_toxic_US_county.rds"))
  ...
  saveRDS(pyr_ld50, file = paste0("clean_data/pesticide/pyrethroid_US_county.rds"))
