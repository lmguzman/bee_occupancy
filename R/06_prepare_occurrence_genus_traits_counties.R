...
prepare_occurrence <- function( year_range, family_filter, oc_interval, region_filter, strict_filter){
  ...
  saveRDS(all_data_env, paste0("clean_data/data_prepared/my_data_env_genus_counties_trait_", paste0(year_range, collapse = "_"), "_", family_filter,"_", region_filter, strict_filter,".rds" ))
...
prepare_occurrence( c(1995, 2015), "ALL", 3, "Center", FALSE)

#prepare_occurrence( c(1995, 2015), "ALL", 3, "NorthEast", TRUE)

prepare_occurrence( c(1995, 2015), "ALL", 3, "SouthEast", FALSE)
