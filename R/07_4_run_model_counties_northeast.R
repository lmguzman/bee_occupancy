...
run_model(c(1995, 2015), 'ms_era_1_area', "ALL", "NorthEast")

run_model(c(1995, 2015), 'ms_env_area_2', "ALL", "NorthEast")

run_model(c(1995, 2015), 'ms_env_era_area_2', "ALL", "NorthEast")
